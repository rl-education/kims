...
class ActorCritic:
    ...
    def train(self, max_steps: int) -> None:
        ...
        # TODO 4: Update network per each step
        # TODO 5: Update network if batch is full
    ...
    def update_value_network(self, td_error: Tensor) -> None:
        ...
        Notes:
            Loss = TD Error^2
        """
        # TODO 2: Compute and update value loss
    ...
    def update_policy_network(self, transition: Transition, td_error: Tensor) -> None:
        ...
        """
        # TODO 3: Compute and update policy loss
